...
This document is the report for my Artificial Intelligence coursework. It will detail my approaches to the problems faced as well justification and evaluation.

\section{Task 1: Basic Scheduling}
I decided to use a backtracking algorithm for this task.   
